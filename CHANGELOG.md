...
## [1.1.0](https://github.com/InspectorHub/OpenInspection/compare/openinspection-v1.0.0...openinspection-v1.1.0) (2026-09-06)
...
* agent CRM directory, seat-invite cancel/resend, M20 removal, eslint hardening ([#261](https://github.com/InspectorHub/OpenInspection/issues/261)) ([ae82be3](https://github.com/InspectorHub/OpenInspection/commit/ae82be3deee220f59c3a0801755557f92e5f4de0))
* agent report-access program (people/role profiles, role-aware sending, agent unified link) + viewer timezones ([#258](https://github.com/InspectorHub/OpenInspection/issues/258)) ([528aacf](https://github.com/InspectorHub/OpenInspection/commit/528aacf92b8723e6db801cff6e9e69485a3b7845))
...
* **agent:** agent terms belong to the deployment, and the signup page finally shows them ([bd8a7f1](https://github.com/InspectorHub/OpenInspection/commit/bd8a7f1400946fd3179c9dda13e796570e0d7b9c))
...
* **calendar:** multiprovider connections with encrypted credentials ([#199](https://github.com/InspectorHub/OpenInspection/issues/199)) ([#251](https://github.com/InspectorHub/OpenInspection/issues/251)) ([67ce903](https://github.com/InspectorHub/OpenInspection/commit/67ce903e10376b821dada7e21dab609255352e14))
...
* **compliance:** two classifications that were absences become findings with reasons ([e7343af](https://github.com/InspectorHub/OpenInspection/commit/e7343af3bd7268aa51f7c9829575b09c5071d663))
...
* **destruction:** a record now says what it measured, and completed stops implying certifiable ([0744f1f](https://github.com/InspectorHub/OpenInspection/commit/0744f1f911fcb49c97040582ba41c38122708451))
* **destruction:** tell the controller we did not finish, while there is still an address to tell ([1503fb1](https://github.com/InspectorHub/OpenInspection/commit/1503fb1247231d7bcffef272fe5d1fb4ef1eebfa))
...
* **esign:** a signature records that someone acted, not that a picture exists ([4dec2dd](https://github.com/InspectorHub/OpenInspection/commit/4dec2dde274a71117f4093238fbf04682e5b4d30))
...
* i18n foundation — tz-aware + locale/currency formatting + Paraglide language framework ([#253](https://github.com/InspectorHub/OpenInspection/issues/253)) ([bf33a37](https://github.com/InspectorHub/OpenInspection/commit/bf33a37317bec8438e976562ff2676d7e78c9342))
...
* **legal:** an agent is a third party, and now signs something that says so ([ffe325d](https://github.com/InspectorHub/OpenInspection/commit/ffe325d6a8933af7045aec70a142db19595ef229))
...
* **notifications:** the class vocabulary stops lying, learns to be asked, and gains the two messages that were never sent ([6c190bb](https://github.com/InspectorHub/OpenInspection/commit/6c190bb6864d40d6f733b70120fe21ad57f03242))
...
* **privacy:** report-view counting becomes a decision the tenant can actually make ([9b9fddf](https://github.com/InspectorHub/OpenInspection/commit/9b9fddf089d12f8589ed1e11bf0950ef3ceb60e8))
* **privacy:** the cross-tenant lookup says what it does, and a person can leave it ([0a430c0](https://github.com/InspectorHub/OpenInspection/commit/0a430c06c1a45d383a8fff273db96615a556de15))
* **purge:** destroy the collaborative documents too, and refuse to call it finished when we could not ([be4aaec](https://github.com/InspectorHub/OpenInspection/commit/be4aaec4936f23d243a1e3306d5ad10c568f7297))
* **purge:** the two Durable Objects that hold storage learn how to empty it ([4c3022d](https://github.com/InspectorHub/OpenInspection/commit/4c3022d5f23ee378020b7a57bbeab9f7c51ecd28))
* report style presets, inspector credentials, email attachment fix ([#260](https://github.com/InspectorHub/OpenInspection/issues/260)) ([9b6ad3f](https://github.com/InspectorHub/OpenInspection/commit/9b6ad3f1874d4eb2f0409a823538624e10525986))
...
* **retention:** report PDFs actually expire, and a rule that cannot finish says so ([de8110d](https://github.com/InspectorHub/OpenInspection/commit/de8110d4bfc5cfd4243800542a69dd9995ffa1e9))
* **retention:** report PDFs get a window, and the disclosure says who chose it ([32d6f88](https://github.com/InspectorHub/OpenInspection/commit/32d6f88ce6a4b12e6518814b1e90ecb30c053ce7))
* **retention:** the signature and the PDF holding its picture expire together ([9520524](https://github.com/InspectorHub/OpenInspection/commit/9520524a08ca6a5be9a5621bc58b1bfec9c3f818))
* **scheduling:** Phase A-core — My Schedule, blocks, holidays, slot engine ([#252](https://github.com/InspectorHub/OpenInspection/issues/252)) ([a39dc06](https://github.com/InspectorHub/OpenInspection/commit/a39dc06b4e1026f23657e768c3d61db0057aec2e))
* settings section-nav + selection-control unification ([#250](https://github.com/InspectorHub/OpenInspection/issues/250)) and Google Places address autocomplete + property auto-fill ([#198](https://github.com/InspectorHub/OpenInspection/issues/198), [#200](https://github.com/InspectorHub/OpenInspection/issues/200)) ([#259](https://github.com/InspectorHub/OpenInspection/issues/259)) ([d0fe780](https://github.com/InspectorHub/OpenInspection/commit/d0fe7801528a2c24030560d1ae343e6cdfd1bbb5))
* **settings:** UTC-offset timezone pickers + pin Node 22 ([#248](https://github.com/InspectorHub/OpenInspection/issues/248)) ([06ae056](https://github.com/InspectorHub/OpenInspection/commit/06ae056baa4dbe1583c7d307a55cce6d740673f6))
* **sms:** a consent points at text that can no longer move ([83ce4e4](https://github.com/InspectorHub/OpenInspection/commit/83ce4e491e8593dcf12494eb140bec1c77891d5a))
* **sms:** jurisdictional messaging rules become data, with the citations and the gaps both named ([ef85a3d](https://github.com/InspectorHub/OpenInspection/commit/ef85a3d807c3d9da2f71695f2c26ffb6826fc1e8))
* **sms:** marketing content cannot ride a transactional consent, and the check cannot be skipped ([81ea861](https://github.com/InspectorHub/OpenInspection/commit/81ea861d355385d3c07451a7c53aa10de11e4ef5))
* **sms:** who sent it, and on whose behalf — recorded rather than inferred ([81c171b](https://github.com/InspectorHub/OpenInspection/commit/81c171bf2ccdfd824ac4d4161c2281d45c6bd9c3))
...
* timezone configuration (tenant default + per-user override) ([#247](https://github.com/InspectorHub/OpenInspection/issues/247)) ([75f7a05](https://github.com/InspectorHub/OpenInspection/commit/75f7a05285b6b0b70eb488cf5fd310fba196aa4c))
...
* **deps:** collapse every brace-expansion copy onto the patched version ([#284](https://github.com/InspectorHub/OpenInspection/issues/284)) ([e6460d6](https://github.com/InspectorHub/OpenInspection/commit/e6460d6f109dd9e76d737810a651e18c766c7f23))
* **deps:** dompurify 3.4.12 -&gt; 3.4.13 (GHSA IN_PLACE hook removal XSS) ([#303](https://github.com/InspectorHub/OpenInspection/issues/303)) ([8a98389](https://github.com/InspectorHub/OpenInspection/commit/8a983891c9a5fcc518480689ccd4d9aed07b7b3f))
...
* **deps:** patch brace-expansion and postcss ([#282](https://github.com/InspectorHub/OpenInspection/issues/282)) ([59e3c43](https://github.com/InspectorHub/OpenInspection/commit/59e3c43cb858cd5545da5950305a8d7739b83de5))
...
* **deps:** transitive nanoid, and a pre-push gate that asks the registry directly ([#304](https://github.com/InspectorHub/OpenInspection/issues/304)) ([e6df0f4](https://github.com/InspectorHub/OpenInspection/commit/e6df0f41bf3cdcc8f38de65bd1a75d16657a4425))
...
* **gates:** the store registry called a SaaS queue deleted because it could not see the config ([7a11c27](https://github.com/InspectorHub/OpenInspection/commit/7a11c27257fbbc1ef09e5451ab05b55a28b938a1))
...
* harden agent report-access program (post-merge review of [#258](https://github.com/InspectorHub/OpenInspection/issues/258)) ([#262](https://github.com/InspectorHub/OpenInspection/issues/262)) ([4a4c6de](https://github.com/InspectorHub/OpenInspection/commit/4a4c6de1a61d822c624c39519ddddbdf2200199c))
* **hooks:** the live-contract gate measured a new branch from the fork's stale main ([6c62654](https://github.com/InspectorHub/OpenInspection/commit/6c62654dfb9b68b66089a04005611cd68acd5f6d))
...
* **idempotency:** a claim whose holder died blocked the key forever ([#300](https://github.com/InspectorHub/OpenInspection/issues/300)) ([9cfc73b](https://github.com/InspectorHub/OpenInspection/commit/9cfc73b7c6d4ff8e4058e4f217eb181ce72ff1a6))
...
* **kv:** a token that outlives its tenant by thirty days becomes reachable by prefix ([baa5dfd](https://github.com/InspectorHub/OpenInspection/commit/baa5dfdd1e169cd889824eb899a6a980b40c2d85))
...
* **qbo:** nine paths that had never worked, and a contract suite so the tenth is found by a test ([#312](https://github.com/InspectorHub/OpenInspection/issues/312)) ([fa78bb3](https://github.com/InspectorHub/OpenInspection/commit/fa78bb3baa321ad29e732baf20410735a891d3b4))
...
* **qbo:** three paths that never worked, the deployment mode they hid in, and two gates ([#313](https://github.com/InspectorHub/OpenInspection/issues/313)) ([ba30e4e](https://github.com/InspectorHub/OpenInspection/commit/ba30e4e17253d1e37e939232eb392efa002da33d))
...
* **gates:** skip the api type-check on front-end commits, and stop recompiling messages ([#288](https://github.com/InspectorHub/OpenInspection/issues/288)) ([4df4959](https://github.com/InspectorHub/OpenInspection/commit/4df495993a98619a0aaf3257fc5db2ca6d3ed8c7))
