...
<!--
COUNSEL-READY v4 — rounds 29, 31 and 32 landed. NOT APPROVED FOR PUBLICATION.
...
`npm run agent-terms:publish`. It prints counsel's round 32 publish-gate checklist
...
**Status:** counsel-ready draft (v4) — not published
