...
export function CostExportButtons({
  ...
  if (variant === "panel") {
    ...
    return (
      <div className="flex items-center gap-3" data-testid="cost-export-panel">
        <a href={href("csv")} download className={link} data-testid="cost-export-csv">
          <Icon name="download" size={13} /> CSV
        </a>
        <a href={href("xlsx")} download className={link} data-testid="cost-export-xlsx">
  ...
  return (
    <div className="contents" data-testid="cost-export-fab">
      <a href={href("csv")} download className={pill} data-testid="cost-export-csv">
        <Icon name="download" size={16} /> CSV
      </a>
      <a href={href("xlsx")} download className={pill} data-testid="cost-export-xlsx">
