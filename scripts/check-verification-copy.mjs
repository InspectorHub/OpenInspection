 ...
 * extended by round 26-9 (2026-08-17).
 *
 ...
 * Round 26-9 promoted it and named it: **Verification Claim Integrity**. The
 ...
 * "Verified Document", and (round 26-9) "Authentic Signature", "Genuine
...
const BANNED = [
  ...
  // ── Round 26-9. Eight more disguises, each with the same shape: an integrity
 ...
 *
 * ── Round 26-9 added eight claims, and every one of them reuses an ordinary
 ...
 *    deliberately NOT banned, because counsel already approved "Audit chain is
 ...
 *    over a rendered image. A caption is not a claim. Counsel's prohibition is
...
const MUST_NOT_FLAG = [
  ...
  // Counsel's approved narrow wording (round 26-9). Highest false-positive cost
  ...
  // a word one of the round 26-9 rules bans, and is why that rule is narrow.
