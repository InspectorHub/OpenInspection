...
export default defineConfig({
  resolve: {
    alias: {
      ...
      'cloudflare:workers': path.resolve(__dirname, 'api/tests/unit/stubs/cloudflare-workers.ts'),
    },
  },
  test: {
    globals: true,
    ...
    setupFiles: ['api/tests/unit/setup-client.ts'],
    include: ['api/tests/unit/**/*.spec.ts'],
    coverage: {
      provider: 'v8',
