...
describe('B-29+ importContacts phase 2 — real D1 bind limit', () => {
    beforeAll(async () => {
        ...
        await b.DB.exec(
            ...
            // appended `locale`. They must be here even though this spec never
            // reads them: drizzle's INSERT lists every column in the schema, so
            // a missing one fails the whole batch.
