 ...
 *
 * The rule it enforces: counsel round 8 named eight categories of content
...
describe('non-translatable registry gate', () => {
    ...
    it('reports a NON-EMPTY registry covering all eight categories', () => {
        ...
        expect(output).toMatch(/[1-9]\d* manifest entries covering 8\/8 counsel categories/);
    ...
    describe('against the probe fixture', () => {
        ...
        it('names a category counsel never ruled on', () => {
