 ...
 *
 * The number survived a counsel review; its old reasoning did not. The
 * "5 + 2 = 7" derivation this repository used to carry was put to counsel and
 * REJECTED (round 24, ruling 24A): Illinois is five years OR two years past
...
describe('the basis is data, not prose', () => {
    ...
    it('carries counsel\'s wording verbatim, including the disclaimer sentence', () => {
        // Supplied by counsel and not to be paraphrased. The assertion is on
    ...
    it('every jurisdiction fact carries an as-of date', () => {
        ...
        // structure refuses to hold one (round 24, second constraint).
    ...
    it('does not claim seven years is the longest statutory period anywhere', () => {
        // The exact sentence counsel struck. Asserting its absence is cheap and
