 ...
 * this side captures it, and counsel A2's invariant applies exactly as it does
 * on the portal-originated path. Counsel round 24 ruling 24D is why it is a
...
describe('joinTeam records the acceptance in the same write as the member row', () => {
    ...
    it('the outbound user.invited carries the acceptance beside the account it creates', async () => {
        ...
        // them is the belief ruling 24D is about.
