...
function buildApp(db: BetterSQLite3Database<typeof schema>, stubs: Stubs = {}) {
    ...
    // PRESENTATION (counsel round 26 — intent comes from an act, never inferred
 ...
 *
 * The sign route now refuses a signature with no recorded PRESENTATION (counsel
 * round 26: intent comes from an act, never inferred from a signature image
...
describe('public agreement routes — per-signer (Track I-a)', () => {
    ...
    it('a signature with NO recorded presentation is refused', async () => {
        ...
        // document. Counsel round 26 — intent must come from a recorded act, not
