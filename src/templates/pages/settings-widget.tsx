    ...
    return (
        <MainLayout title={`${siteName} | Embed Booking Widget`} branding={branding}>
            <div class="space-y-6 animate-fade-in">
                ...
                <section class="glass-panel p-4 rounded-lg shadow-xl shadow-slate-100/50 space-y-6">
                ...
                <section class="glass-panel p-4 rounded-lg shadow-xl shadow-slate-100/50 space-y-6">
                    ...
                    <pre id="widgetSnippet" class="bg-slate-900 text-emerald-300 p-4 rounded-lg overflow-x-auto text-xs font-mono"></pre>
