  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <section className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
        ...
        <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-1">Your referral link</h2>
        ...
        <label htmlFor="agentSlug" className="block text-[12px] font-semibold text-slate-600 dark:text-slate-300 mb-1.5">Slug</label>
        <div className="flex gap-2">
          <input
            ...
            placeholder="jane"
            className="flex-1 h-9 px-3 rounded-md border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-[13px] font-medium placeholder:text-slate-400 transition-all"
          />
          <button className="h-9 px-4 rounded-md bg-indigo-600 text-white font-bold text-[13px] hover:bg-indigo-700 transition-colors uppercase tracking-wide">
            Save slug
          </button>
        </div>
        ...
        {previewLink && (
          <div className="mt-3 bg-slate-50 dark:bg-slate-900/40 rounded-md px-3 py-2 text-[12px] font-mono text-slate-500 break-all">
            {previewLink}
          </div>
        )}
      </section>
      ...
      <section className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6">
        ...
        <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-1">Email me when...</h2>
        <p className="text-[13px] text-slate-500 dark:text-slate-400 mb-4">
    ...
    <div className="flex items-center gap-4 py-3">
      ...
      <button
        ...
        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors shrink-0 ${
          on ? "bg-emerald-500" : "bg-slate-200 dark:bg-slate-600"
        }`}
      >
