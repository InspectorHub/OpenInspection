  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="flex gap-2 mb-6">
        {ds.safety > 0 && (
          <span className="text-[11px] font-bold px-2 py-1 rounded bg-red-50 text-red-600 dark:bg-red-900/20 dark:text-red-400">
            {ds.safety} Safety
          </span>
        )}
        {ds.recommendation > 0 && (
          <span className="text-[11px] font-bold px-2 py-1 rounded bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400">
