    ...
    <div className="flex h-screen bg-white dark:bg-slate-900">
      ...
      {blocker.state === "blocked" && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          <div
            ...
            onClick={cancelLeave}
          />
          <div className="relative bg-white dark:bg-slate-800 rounded-lg shadow-xl p-6 max-w-sm w-full">
            <h3 className="text-[15px] font-bold text-slate-900 dark:text-slate-100">
              Unsaved changes
            </h3>
            <p className="text-[13px] text-slate-600 dark:text-slate-300 mt-2">
      ...
      {state.showCommentLibrary && (
        <div className="fixed inset-0 z-[80] flex">
          ...
          />
          <div className="relative ml-auto w-full max-w-md bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-700 shadow-2xl flex flex-col h-full">
            ...
            {/* Filter chips */}
            <div className="flex gap-1 px-4 py-2 border-b border-slate-200 dark:border-slate-700 flex-wrap">
              {[
                { id: "all", label: "All" },
            ...
            <div className="px-4 py-2">
              <input
                ...
                className="w-full px-3 py-2 rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-[12px]"
                autoFocus
              />
        ...
        <div className="h-14 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 flex items-center px-4 gap-3">
          ...
          <div className="hidden lg:flex items-center">
            <input
              ...
              className="w-44 h-8 px-3 rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-[12px]"
            />
          </div>
            ...
            <div className="flex items-center justify-center h-full text-slate-400">
              <div className="text-center">
                ...
                <p className="text-[11px] mt-2 text-slate-300">
                  Press <kbd className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-700 rounded text-[10px] font-mono border">J</kbd> / <kbd className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-700 rounded text-[10px] font-mono border">K</kbd> to navigate
                </p>
              </div>
            </div>
          )}
      ...
      {!offline.online && (
        <div className="fixed top-14 left-0 right-0 z-40 bg-amber-50 dark:bg-amber-900/30 border-b border-amber-200 dark:border-amber-700 px-4 py-2 text-center">
