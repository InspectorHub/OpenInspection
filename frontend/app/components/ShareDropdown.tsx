  ...
  return (
    <div className="relative print:hidden" ref={ref}>
      <button
        ...
        aria-expanded={open}
        aria-haspopup="menu"
        className="h-9 px-3 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-[13px] font-bold inline-flex items-center gap-1.5 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-1 w-56 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-lg overflow-hidden z-10" role="menu">
          <button type="button" onClick={copyLink} role="menuitem" className="w-full px-4 py-2.5 text-left text-[13px] font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 flex items-center gap-2">
          ...
          <button type="button" onClick={emailLink} role="menuitem" className="w-full px-4 py-2.5 text-left text-[13px] font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 flex items-center gap-2">
