...
CREATE TABLE `__new_tenant_configs` (
	...
	`sms_mode` text DEFAULT 'own' NOT NULL,
	`byo_provider` text,
...
--> statement-breakpoint
INSERT INTO `__new_tenant_configs`("tenant_id", "company_name", "primary_color", "logo_url", "support_email", "company_address", "pdf_show_footer", "pdf_show_page_numbers", "pdf_show_license", "sender_email", "reply_to", "email_mode", "video_mode", "sms_mode", "byo_provider", "sender_display_name", "point_of_contact", "billing_url", "review_url", "company_phone", "integration_config", "secrets_enc", "dek_enc", "ics_token", "widget_allowed_origins", "report_theme", "attention_thresholds", "inspection_prefs", "show_estimates", "enable_repair_list", "enable_customer_repair_export", "block_unpaid", "block_unsigned_agreement", "custom_referral_sources", "dashboard_column_prefs", "concierge_review_required", "allow_inspector_choice", "enable_pdf_pipeline", "team_mode_default", "apprentice_review_required", "guest_invites_enabled", "require_defect_fields", "agreement_retention_years", "reinspection_statuses", "collab_editing", "updated_at") SELECT "tenant_id", "company_name", "primary_color", "logo_url", "support_email", "company_address", "pdf_show_footer", "pdf_show_page_numbers", "pdf_show_license", "sender_email", "reply_to", "email_mode", "video_mode", "sms_mode", NULL, "sender_display_name", "point_of_contact", "billing_url", "review_url", "company_phone", "integration_config", "secrets_enc", "dek_enc", "ics_token", "widget_allowed_origins", "report_theme", "attention_thresholds", "inspection_prefs", "show_estimates", "enable_repair_list", "enable_customer_repair_export", "block_unpaid", "block_unsigned_agreement", "custom_referral_sources", "dashboard_column_prefs", "concierge_review_required", "allow_inspector_choice", "enable_pdf_pipeline", "team_mode_default", "apprentice_review_required", "guest_invites_enabled", "require_defect_fields", "agreement_retention_years", "reinspection_statuses", "collab_editing", "updated_at" FROM `tenant_configs`;--> statement-breakpoint
