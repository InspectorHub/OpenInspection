...
> **Not legal advice.** The templates below encode the functional elements required by US carrier programs (CTIA Messaging Principles, Twilio/Telnyx Acceptable Use Policies). Have review review the final TCPA/CTIA wording before publishing.
