 ...
 *
 * Counsel round 8 (`docs/legal/2026-08-08-counsel-round-8-response.md`) ruled on
 ...
 * disclosure shown alongside an agreement) are platform notices. Counsel
...
/**
 * The eight categories counsel named. A CLOSED set.
 *
...
export interface NonTranslatableEntry {
    ...
    id: string;
    /** Which of counsel's eight categories this is. */
