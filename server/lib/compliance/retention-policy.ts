 ...
 * purpose-based derivation. The engine's own windows were not put to counsel
 ...
 *   6. ❌ `migration_batches` — added 2026-08-19, NOT put to counsel. Rounds 33
 ...
 *         the record itself carries no third-party data. Counsel has not been
 ...
 * SCHEDULED deletion, which is what counsel's invariant covers. It does not
...
export const RETENTION_POLICY: RetentionPolicyHeader = {
    ...
    // Round 34 remains what approved the seventeen rules it saw. It does NOT
