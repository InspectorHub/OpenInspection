 ...
 *
 * ── What counsel struck, and why it matters here ────────────────────────────
 ...
 * counsel, that derivation was REJECTED (round 24, ruling 24A). Illinois is
 ...
 * That is a controller instruction under counsel's round-14 framing, which the
...
export interface RetentionJurisdictionFact {
     ...
     * date cannot be known to be stale (round 24, second constraint).
     */
    checkedOn: string;
}
...
export const REPORT_PDF_RETENTION_BASIS = {
    ...
    /**
     * Counsel's replacement wording, VERBATIM. Not to be paraphrased — the
