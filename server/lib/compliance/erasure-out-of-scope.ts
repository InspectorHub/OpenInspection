...
export const ERASURE_OUT_OF_SCOPE: ErasureOutOfScopeEntry[] = [
    ...
    // COUNSEL ROUND 26. 'staff signature asset' said WHOSE it is and stopped
    // there, which left the column indefinite by omission rather than by
    // decision — and counsel is explicit that a staff signature may not inherit
    ...
    // row it belongs to (counsel A2 / round 24 ruling 24D). The subject is an
