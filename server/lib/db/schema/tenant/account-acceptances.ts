 ...
 *
 * Counsel A2's invariant is that an account and its acceptance are ONE write. The
 ...
 * the portal ledger become consistent afterwards, and counsel refused it —
 * `FAIL-CLOSED NOT SATISFIED` (round 24, ruling 24D). The distinction they drew is
