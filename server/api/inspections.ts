...
import { inspections as inspectionTable, inspectionResults, agreements, users, contacts, inspectionMediaPool, inspectionInspectors, agreementRequests, agreementSigners } from '../lib/db/schema';
